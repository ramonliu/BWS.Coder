        ...
        return `
            <div class="dashboard-overlay" id="dashboardOverlay">
                <div class="dashboard-header">
                    <div class="dashboard-title">${t(lang, 'ui_dashboardTitle')}</div>
                    <div class="dashboard-actions">
                        <div class="dashboard-action-btn" onclick="popOutDashboard()" title="${t(lang, 'ui_popOutDashboard')}">
                        ...
                        <div class="dashboard-close" onclick="toggleDashboard()" title="${t(lang, 'ui_close')}">
