        ...
        return `
            <div class="toolbar">
                ...
                <div class="mode-selector">
                    ...
                    <label for="mode-workflow" title="Auto-execute workflow tasks">Workflow</label>
                    <input type="radio" id="mode-group" name="chat-mode" value="Group" onchange="window.setChatMode('Group')">
                    <label for="mode-group" title="Broadcast to multiple LLMs">Group</label>
                    <input type="radio" id="mode-single" name="chat-mode" value="Single" checked onchange="window.setChatMode('Single')">
                    <label for="mode-single" title="Standard single chat">Single</label>
                </div>

                <div style="flex:1"></div>

                <button class="toolbar-btn" id="historyToggle" onclick="window.toggleHistory()" title="History"><svg viewBox="0 0 16 16"><path d="M8.5 2c-1.8 0-3.4.7-4.6 1.9L2.8 2.8C2.5 2.5 2 2.7 2 3.2V7c0 .6.4 1 1 1h3.8c.5 0 .7-.5.3-.8L5.7 5.7C6.4 5 7.4 4.5 8.5 4.5c2.5 0 4.5 2 4.5 4.5s-2 4.5-4.5 4.5c-1 0-2-.4-2.8-1-.4-.3-.9-.2-1.2.2-.3.4-.2.9.1 1.2 1.1.9 2.4 1.4 3.9 1.4 3.6 0 6.5-2.9 6.5-6.5S12.1 2 8.5 2z"/></svg></button>
                <button class="toolbar-btn" onclick="window.startNewChat()" title="New Chat"><svg viewBox="0 0 16 16"><path d="M14 7H9V2H7v5H2v2h5v5h2V9h5V7z"/></svg></button>
                <button class="toolbar-btn" onclick="window.sendHandover()" title="Save Handover"><svg viewBox="0 0 16 16"><path d="M13.8 3l-1.6-1.6V1.4c0-.2-.1-.3-.2-.4H2.5c-.3 0-.5.2-.5.5v12.5c0 .3.2.5.5.5h11c.3 0 .5-.2.5-.5V3.4c0-.2-.1-.3-.2-.4zM8 13c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3-8H3V3h8v2z"/></svg></button>
            </div>
        `;
    }
}
